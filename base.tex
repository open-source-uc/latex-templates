...
\ifthenelse{
    \equal{\mostrarPuntos}{Si} \OR{} \equal{\mostrarPuntos}{Sí} \OR{} \equal{\mostrarPuntos}{Verdadero} \OR{} \equal{\mostrarPuntos}{si} \OR{} \equal{\mostrarPuntos}{sí} \OR{} \equal{\mostrarPuntos}{verdadero} \OR{} \equal{\mostrarPuntos}{SÍ} \OR{} \equal{\mostrarPuntos}{SI}
}{
...
% -----------------------------------------------------
\ifthenelse{
    \equal{\tieneSecciones}{Si} \OR{} \equal{\tieneSecciones}{Sí} \OR{} \equal{\tieneSecciones}{si} \OR{} \equal{\tieneSecciones}{sí} \OR{} \equal{\tieneSecciones}{SÍ} \OR{} \equal{\tieneSecciones}{SI}
}
...
% Establece la familia del documento (evaluación o guía)
\ifthenelse{
    \equal{\tipoDocumento}{interrogacion} \OR
    \equal{\tipoDocumento}{interrogación} \OR
    \equal{\tipoDocumento}{Interrogacion} \OR
    \equal{\tipoDocumento}{Interrogación} \OR
    \equal{\tipoDocumento}{control} \OR
    \equal{\tipoDocumento}{Control}}
{\newcommand{\familiaDocumento}{evaluación}} % if
{\newcommand{\familiaDocumento}{guía}} % else

% Maneja el soporte de emojis
\ifthenelse{\equal{\soportaEmojis}{Si} \OR \equal{\soportaEmojis}{si}}{
