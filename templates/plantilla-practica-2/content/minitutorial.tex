...
En esta plantilla hay 2 formas de incluir imágenes. La primera es la más compleja y manual es usando esta estructura:
\begin{verbatim}
...
La forma manual de hacerlo es seguir esta estructura:
\begin{verbatim}
...
La forma manual de hacerlo es siguiendo esta estructura:
\begin{verbatim} 
\begin{table}[H]
    \centering
    \begin{measuredfigure}
...
Pueden copiar y modificar el código siguiente:
...
El texto citado vería de la siguiente forma
\quotex{\lipsum[1] (Autor, Año)}
