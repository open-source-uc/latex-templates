...
\begin{coverpages}
    \begin{flushleft}
        ...
        \siEsEvaluacion{\siResponderTodo{Para esta evaluación \textbf{debes intentar responder todas las preguntas.\\[\baselineskip]}}{Para esta evaluación, debes responder \textbf{solo} \NUMBERstringnum{\total{numeroDePreguntas}} preguntas.\\[\baselineskip]}}{}%
